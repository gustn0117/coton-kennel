    ...
    <>
      ...
      <Section className="pt-20 lg:pt-28">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {REVIEWS.map((r, i) => (
            <article
              key={i}
              className="rounded-3xl bg-cream-50 p-3 ring-1 ring-cream-300/50 transition-all hover:-translate-y-1 hover:shadow-md"
            >
      ...
      <Section className="pt-24 lg:pt-32">
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-3">
          {VISIT_STEPS.map((s, i) => (
            <article
              key={i}
              className="relative overflow-hidden rounded-3xl bg-cream-50 p-8 ring-1 ring-cream-300/50"
            >
              <span className="font-serif text-5xl font-bold text-kennel-gold opacity-90">
                {s.num}
              </span>
      ...
      <Section className="pt-24 lg:pt-32">
        <div className="grid gap-8 md:grid-cols-2">
          <div className="aspect-[4/3] w-full overflow-hidden rounded-3xl ring-1 ring-cream-300/50">
            <PuppyImage variant="p7" />
          </div>
          <div className="rounded-3xl bg-cream-50 p-8 ring-1 ring-cream-300/50 md:p-10">
            ...
            <ul className="mt-6 space-y-3 text-sm text-ink-700">
              <li className="flex justify-between border-b border-cream-300 pb-3">
                <span className="font-medium text-ink-500">운영 시간</span>
                <span>매일 11:00 ~ 19:00</span>
              </li>
              <li className="flex justify-between border-b border-cream-300 pb-3">
            ...
            <a
              href="/contact"
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-kennel-btn px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-kennel-dark"
            >
              방문 예약하기
