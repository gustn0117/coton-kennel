...
export default function VisitorGuidePage() {
  ...
  return (
    <>
      ...
      <section className="mx-auto w-full max-w-page-wide px-6 py-16 lg:px-[180px] lg:py-[233px]">
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:mt-[140px] lg:grid-cols-3 lg:gap-[60px]">
          {visible.length > 0
